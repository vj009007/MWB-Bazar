                        ...
                        <tr className="border-b align-baseline">
                          ...
                          <td className="py-4 px-6 color-[#2E2C34;]">
                            <div className="text-center">
                              <button className="bg-transparent hover:bg-[#FD6B09] text-[#FD6B09] font-semi-bold hover:text-white py-2 px-4 border border-[#FD6B09] hover:border-transparent rounded">
                                APPLY
                              </button>
